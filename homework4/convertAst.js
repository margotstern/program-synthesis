...
// let ast = "(ite (<= x y) y x)"
// var ast_replace = ast.replaceAll('(', '').replaceAll(')', '')
// console.log(ast_replace.split(" "))


// console.log(ast_replace);
// // let ast_splt = ast.split(" ")

// // console.log(astToCodeP(ast))